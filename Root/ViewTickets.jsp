  ...
  <body>
    ...
    <% 
        ...
        try 
        {
            ...
            ResultSet rs = stmt.executeQuery("SELECT event.eventName, event.location, event.date_and_time, hastickets.eventID, tickets FROM ticketmaster.hastickets,ticketmaster.event where hastickets.userID = '"+session_username+"' AND ticketmaster.hastickets.eventID = ticketmaster.event.eventID");
            int i = 1;
            while(rs.next()) 
            {
